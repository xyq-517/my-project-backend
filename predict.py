...
if __name__ == "__main__":
    ...
    #-------------------------------------------------------------------------#
    dir_origin_path = r"D:\shengwu\using\unet-pytorch\VOCdevkit_kits19\VOC2007\JPEGImages"
    dir_save_path   = "img_out_2/"
    #-------------------------------------------------------------------------#
    ...
    if mode == "predict":
        ...
        # --- 修改部分开始 ---
        # 读取 test.txt 获取图片名列表
        with open(r"D:\shengwu\using\unet-pytorch\VOCdevkit_kits19\VOC2007\ImageSets\Segmentation\test.txt", "r") as f:
            img_names = [line.strip() + ".jpg" for line in f.readlines()]
        # --- 修改部分结束 ---
