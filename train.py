...
#from nets.unet2_ca import UNet as Unet
...
#在SwinUnet.py中window_size=8适应512x512输入、window_size=16适应1024x1024输入、window_size=4适应256x256输入 img_size=256或512或1024 
...
#修改为(64,64)以适应1024x1024输入、(32,32)以适应512x512输入，(16,16)以适应256x256输入
...
if __name__ == "__main__":
    ...
    #   数据集路径
    #------------------------------#
    VOCdevkit_path  = r'F:\VOCdevkit_lidc'
    #------------------------------------------------------------------#
    #   建议选项：
    #   种类少（几类）时，设置为True
    ...
    if local_rank == 0:
        ...
        loss_history    = LossHistory(log_dir, model, input_shape=input_shape, use_tensorboard=use_tensorboard)
    else:
        loss_history    = None
