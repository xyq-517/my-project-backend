...
from utils.utils_metrics import f_score, compute_hd95
...
def fit_one_epoch(model_train, model, loss_history, eval_callback, optimizer, epoch, epoch_step, epoch_step_val, gen, gen_val, Epoch, cuda, dice_loss, focal_loss, cls_weights, num_classes, fp16, scaler, save_period, save_dir, local_rank=0):
    ...
    for iteration, batch in enumerate(gen):
        ...
        if not fp16:
            ...
            with torch.no_grad():
                ...
                _hd95    = compute_hd95(outputs, pngs)
    ...
    if local_rank == 0:
        ...
        print('Total Loss: %.3f || Val Loss: %.3f || Val Dice: %.3f || Val HD95: %.3f' % (total_loss / epoch_step, val_loss / epoch_step_val, val_f_score / epoch_step_val, val_hd95 / epoch_step_val))
